                ...
                <Container style={container}>
                    <Section style={message}>
                        ...
                        <Text style={{ ...global.text, marginTop: 24 }}>
                            If you have any questions regarding of your order, please feel free to contact us with your order number and we're here help.
                        </Text>
                    </Section>
                    <Hr style={global.hr} />
                    ...
                    <Section style={paddingY}>
                        <Row>
                            <Text style={{ ...footer.text, paddingBlock: 30}}>
