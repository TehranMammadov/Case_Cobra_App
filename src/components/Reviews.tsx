...
function Review({imgSrc, className, ...props}: ReviewProps) {
    const POSSIBLE_ANIMATION_DELAYS = ['0s', '0.1s', '0.2', '0.3s', '0.4s', '0.5s']
...
function ReviewGrid() {
    ...
    return (
        <div 
            ref={containerRef} 
            className='relative -mx-4 mt-16 grid h-[49rem] max-h-[150vh] grid-cols-1 items-start gep-8 overflow-hidden px-4 sm:mt-20 md:grid-cols-2 lg:grid-cols-3'
        >
            {isInView ? <>
                <ReviewColumn 
